...
class SenderParam extends AbstractRequest {
	...
	/*
	 * @param $email_on_delivery
	 * @return $this
	 */
	public function setEmailOnDelivery($email_on_delivery)
	{
		$this->email_on_delivery = $email_on_delivery;
		return $this;
	}
	 ...
	 * @return null|
	 */
	public function getEmailOnDelivery()
	{
		return $this->email_on_delivery;
	}
